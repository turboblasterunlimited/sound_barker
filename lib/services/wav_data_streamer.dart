...
//   final waveStreamer = WaveStreamer(soundData).stream;
//   final subscription = waveStreamer.listen(
//     (data) {
//       print('Frame amplitude: $data');
//     },
//     onDone: () {
//       print('Done!');
//     }
...
//   WaveStreamer(Int16List samples) {
...
//       _amplitude = tempSubList.reduce((a, b) => a.abs() + b.abs()) / tempSubList.length;
