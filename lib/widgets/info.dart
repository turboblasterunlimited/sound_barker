...
19a, SIGN IN/SIGN UP OPTIONS: If you signed up with email and password then you can either sign in with email and a password 
or with Google Single Sign On to an account associated with that email. 
An account created with Google Single Sign On can only be accessed by using Google Single Sign On.

19b, GUEST SIGN IN: You can sign in as a guest without revealing any personal information.  Guest users can make and playback cards but they can't share or save them.
...
19a, SIGN IN/SIGN UP OPTIONS: If you signed up with email and password then you can either sign in with email and a password 
or with Google Single Sign On to an account associated with that email. 
An account created with Apple or Google Single Sign On can only be accessed by using Apple or Google Single Sign On respectively.

19b, APPLE SINGLE SIGN ON PRIVACY OPTIONS: When you sign up with Apple Single Sign On 
you are given a choice to show or hide the email associated to that account.  
If you choose to hide your email, then a proxy email address is assigned and 
will be visible when you log out or select About from the main menu.

19c, GUEST SIGN IN: You can sign in as a guest without revealing any personal information.  Guest users can make and playback cards but they can't share or save them.
...
''';
  ...
  Widget build(BuildContext context) {
    var platform_text = Platform.isIOS ? text : google_text;
    return Expanded(
      child: Padding(
              ...
              children: [
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      TextSpan(text: platform_text, style: reg),
                    ],
                  ),
                ),
//                Text(text, style: reg),
