...
class PrivacyPolicyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Center(child: Text("Privacy Policy", style: title)),
          Expanded(
            child: Padding(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Text("    • inform you about our products and services.\n\n",
                      style: reg),
                  Text("How Information is Shared.\n", style: bold),
                  RichText(
                    text: TextSpan(children: [
                      TextSpan(text: "Shared As You Direct. ", style: bold),
                      TextSpan(
                          text:
                  ...
                  RichText(
                    text: TextSpan(children: [
                      TextSpan(text: "Business Transactions. ", style: bold),
                      TextSpan(
                          text:
                  ...
                  Text(
                      "We retain your Personal Information only for as long as is necessary for the purposes set out in this Privacy Policy and to comply with our legal obligations, resolve disputes, and enforce our agreements and policies. We reserve the right to delete any account which has been inactive for three (3) years.",
                      style: reg),
                  Text("Storage and Transfer of your Personal Information. \n",
                      style: bold),
                  Text(
                  ...
                  Text(
                      ...
                      style: reg),
                  Text("In addition, you also have the following rights:\n",
                      style: reg),
                  Text(
